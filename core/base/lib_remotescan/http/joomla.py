...
class Joomla(Http_func):
	...
	def version(self):
		...
		data = re.findall(r'content=(?:\"|\')Joomla! (.*?) - Open Source Content Management(?:\"|\')', r.text)
		return data
